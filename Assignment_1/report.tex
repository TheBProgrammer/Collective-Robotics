...
\begin{enumerate}
    \item \textbf{$r < 0.3$:} Amplitude rises steeply from $\approx 20$ to
          $\approx 120$.  Connectivity is insufficient for global sync; only
...
A low amplitude means fireflies flash nearly independently: at any
moment, roughly half the swarm flashes (${\sim}75$ out of 150), with no
coherent peaks.  A high amplitude means the swarm flashes
